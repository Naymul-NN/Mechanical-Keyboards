    ...
    return (
        <div>
            <div className="carousel-item relative w-full mx-auto h-[500px]  ">
                ...
                <div className='absolute  pl-20 h-full bg-gradient-to-r from-[#1515159d] to-[rgba(21, 21, 21, 0.00)] w-full '>
                    <div className=' space-y-5 pt-32'>
                        ...
                        <button className='px-2 py-2  hover:bg-orange-500 mr-5 bg-pink-400 rounded-lg text-black'>Discover more</button>
                        <Link to="/latest">
